...
QT_MOC_LITERAL(3, 24, 19) // "on_registro_clicked"

    },
    "Registro\0buttonPressed\0\0on_registro_clicked"
};
...
void Registro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Registro::buttonPressed)) {
                *result = 0;
                return;
            }
        }
